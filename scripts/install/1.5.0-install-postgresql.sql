/*
    Memoria 1.5.0 — event store schema install (PostgreSQL)
...
CREATE TABLE IF NOT EXISTS public."DomainAggregateEvents" (
    ...
    CONSTRAINT "FK_DomainAggregateEvents_DomainAggregates_AggregateId" FOREIGN KEY ("AggregateId")
        REFERENCES public."DomainAggregates" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_DomainAggregateEvents_events_EventId" FOREIGN KEY ("EventId")
        REFERENCES public.events ("Id") ON DELETE CASCADE
);

/* ------------------------------------------------------------------ indexes */
CREATE INDEX IF NOT EXISTS "IX_DomainAggregateEvents_EventId"
    ON public."DomainAggregateEvents" ("EventId");
