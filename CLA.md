...
You agree to it once. It then covers every contribution you have already made and every contribution
you make afterwards, unless you and the Owner agree otherwise in writing.

## 1. What the words mean

- **"You"** means the person agreeing to this, or the legal entity on whose behalf they are agreeing.
...
You grant the Owner a perpetual, worldwide, non-exclusive, royalty-free, irrevocable copyright
...
1. Each contribution is your own original work, or you have the right to submit it under this
   agreement.
2. You are legally entitled to grant the licences in sections 2 and 3, and no agreement with anyone
   else prevents you from granting them.
3. If your employer has rights in work you create — because you wrote it on their equipment, in
   their time, or within the scope of your job — you have their permission to contribute it, they
   have waived those rights, or they have agreed to this on your behalf. If you are unsure, ask them
   before you contribute.
4. If any part of a contribution is not your own work, you have identified it in the contribution
   itself: what it is, where it came from, and the licence and restrictions it carries.

## 5. No warranty, and no obligation to use anything

You provide your contributions as they are, without warranty of any kind, express or implied,
including any warranty of merchantability, fitness for a particular purpose, title or
non-infringement — except for the promises you make in section 4, which stand.

The Owner is under no obligation to accept, merge, use, distribute or maintain any contribution.

## 6. Telling the Owner when something changes

If you later learn that anything you confirmed in section 4 is or has become inaccurate, tell the
Owner as soon as you reasonably can.

## 7. Governing law

This agreement is governed by the laws of England and Wales, and the courts of England and Wales
have exclusive jurisdiction over any dispute arising out of it.

## How to agree

Comment on your first pull request with this line, exactly, replacing the name with your own:

```
I have read the Memoria Contributor Licence Agreement and I agree to it. Signed, <your full name>.
```

If you are contributing on behalf of a company, say so and name it:

```
I have read the Memoria Contributor Licence Agreement and I agree to it on behalf of <company>,
which I am authorised to bind. Signed, <your full name>.
```

The comment is the record. You will not be asked again on later pull requests.
