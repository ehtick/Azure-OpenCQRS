...
/// <summary>
/// Proves the shipped PostgreSQL install script stands up the same schema the model declares, so a
...
{
    private const string ScriptFileName = "1.9.0-install-postgresql.sql";
